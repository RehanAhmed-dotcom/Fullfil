...
const InuativescaleTwo = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.middlecontainer}>
          <View>
            <Text
              ...
              I find myself eating when I am stressed out, even when I'm
          ...
          <View style={{marginTop: 15}}>
            <Text
              ...
              I am able to cope with my negative emotions (e.g anxiety, sadness)
          ...
          <View style={{marginTop: 15}}>
            <Text
              ...
              I find other way to cope with stress and anxiety than by eating.
            </Text>
            <View style={{height: 5}} />
            <FlatList
      ...
      <View style={styles.bottomcontainer}>
        <Button
          title={'Next'}
          onPress={() => navigation.navigate('InuativescaleThree')}
...
export default InuativescaleTwo;
