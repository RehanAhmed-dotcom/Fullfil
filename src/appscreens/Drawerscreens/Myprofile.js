...
const Myprofile = ({navigation}) => {
  ...
  useEffect(() => {
    console.log('imageeee', user.userdata);
    setImg(user.userdata.image);
    setUsername(user.userdata.username);
    setFullname(user.userdata.firstname);
    setEmail(user.userdata.email);
    setPhonenum(user.userdata.phoneno);
    setFormatedDate(user.userdata.dob);
    // setDate(user.userData.dob);
  }, []);
  useEffect(() => {
  ...
  const handleConfirm = date => {
    ...
    const mom = moment(currentDate).format('YYYY-MM-DD');
    setFormatedDate(mom);
    setDate(date);
    hideDatePicker();
    setDob(mom);
      ...
      <ScrollView
        ...
        <View style={styles.middlecontainer}>
          <View>
            ...
            <Text style={styles.Namestyle}>Full Name</Text>
            <View style={styles.usernameView}>
              <TextInput
                returnKeyType="done"
                value={fullname}
            ...
            <Text style={styles.Namestyle}>Phone Number</Text>
            <View style={styles.usernameView}>
              <TextInput
                returnKeyType="done"
