...
const InuativescaleThree = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.middlecontainer}>
          ...
          <View style={{marginTop: 15}}>
            <Text
              ...
              I rely on my fullness (satiety) signals to tell me when to stop
              eating.
            </Text>
            <View style={{height: 5}} />
            <FlatList
      ...
      <View style={styles.bottomcontainer}>
        <Button
          title={'Next'}
          onPress={() => navigation.navigate('InuativescaleFoure')}
...
export default InuativescaleThree;
